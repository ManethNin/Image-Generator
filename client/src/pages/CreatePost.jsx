    ...
    <div>
      ...
      <form className ='mt-10 max-w-3x1' onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button type='button' onClick={generateImg} className='text-white bg-green-700 font-medium rounded-md text-sm w-2/12 px-5 py-2.5 text-center' //sm:w-auto
          > 
